...
<div class="mb-8 flex justify-between items-center">
    ...
    <a href="{{ route('admin.projects.create') }}" class="bg-gray-800 text-white px-4 py-2 rounded hover:bg-gray-700">
        + Add New Project
    </a>
</div>
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            @forelse($projects as $project)
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="px-2 py-1 text-xs rounded {{ $project->is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800' }}">
